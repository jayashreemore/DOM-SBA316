//navbar creation
// Function to create top navigation links
function createTopNavLinks() {
    const topNavbar = document.getElementById('top-navbar');
    const navItems = ['Home', 'Shop', 'Cart', 'Account']; // Example navigation items
    ...
    topNavbar.querySelector('#menu-list').appendChild(ul);
}
...
const parentDiv = document.querySelector('.adv');
...
fruitul.firstChild.innerHTML = "blue Berry"
...
t2.innerHTML = div2;
t2.innerText = "Miller Organic farms Inc | \n 9471 Alnwick loop, \nPlain City, Ohio 43016 | \n Mobile :+1 (614) 123-1234 ";
